...
export function ProductsPageClient({ products, categories, categorySlug, currentCategory }: ProductsPageClientProps) {
  const { t } = useLanguage();
  ...
  return (
    <div className="pt-16 lg:pt-24 min-h-screen bg-gray-50">
      {/* Hero Section */}
      <ProductsHero
        title={currentCategory ? getCategoryName(currentCategory.slug) : t('products.title')}
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              <p className="text-gray-600">
                <span className="font-semibold text-gray-900">{products.length}</span>{t('products.productCount')}
              </p>
            </div>
            {currentCategory && (
              <Link
