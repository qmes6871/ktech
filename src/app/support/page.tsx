      ...
      <section className="relative py-12 md:py-16 lg:py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              {t('support.description')}<br className="md:hidden" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <p className="text-sm font-medium text-gray-700">{t('support.phoneInquiry')}</p>
                </div>
                <div className="space-y-2">
                  <a href="tel:+82-42-931-9031" className="block hover:bg-blue-50 rounded-lg p-2 -mx-2 transition-colors">
                    <p className="text-xs text-blue-600 font-semibold">{t('footer.koreaOffice')}</p>
                    <p className="font-semibold text-gray-900 text-sm">Tel. +82-42-931-9031</p>
                  </a>
                  <a href="tel:+86-519-8586-9129" className="block hover:bg-blue-50 rounded-lg p-2 -mx-2 transition-colors">
                    <p className="text-xs text-blue-600 font-semibold">{t('footer.chinaOffice')}</p>
                    <p className="font-semibold text-gray-900 text-sm">Tel. +86-519-8586-9129</p>
                  </a>
                </div>
              </motion.div>
                ...
                <div className="lg:col-span-2 bg-gradient-to-br from-blue-600 to-blue-700 p-8 lg:p-12 text-white">
                  ...
                  <div className="mt-12 pt-8 border-t border-white/20">
                    ...
                    <div className="space-y-4 text-sm">
                      {/* Korea Office */}
                      <div>
                        <p className="text-xs text-blue-300 font-semibold mb-1">{t('footer.koreaOffice')}</p>
                      ...
                      {/* China Office */}
                      <div>
                        <p className="text-xs text-blue-300 font-semibold mb-1">{t('footer.chinaOffice')}</p>
                        <p className="flex items-center gap-2">
                          <svg className="w-4 h-4 text-blue-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                          </svg>
                          Tel. +86-519-8586-9129
                        </p>
                        <p className="flex items-center gap-2 mt-1">
                          <svg className="w-4 h-4 text-blue-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                          </svg>
                          Fax. +86-519-8512-3113
                        </p>
                      </div>
                      {/* Email */}
                      <p className="flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="min-w-0">
                    <h3 className="font-semibold text-gray-900 mb-2">{t('support.location.address')}</h3>
                    <div className="space-y-2">
                      <div>
                        <p className="text-xs text-blue-600 font-semibold">{t('footer.koreaOffice')}</p>
                      ...
                      <div>
                        <p className="text-xs text-blue-600 font-semibold">{t('footer.chinaOffice')}</p>
                        <p className="text-gray-600 text-xs leading-relaxed break-all">
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-2">{t('support.location.contact')}</h3>
                    <div className="space-y-2">
                      <div>
                        <p className="text-xs text-cyan-600 font-semibold">{t('footer.koreaOffice')}</p>
                        <p className="text-gray-600 text-sm">Tel. +82-42-931-9031</p>
                      </div>
                      <div>
                        <p className="text-xs text-cyan-600 font-semibold">{t('footer.chinaOffice')}</p>
                        <p className="text-gray-600 text-sm">Tel. +86-519-8586-9129</p>
                      </div>
                    </div>
                  </div>
                </div>
